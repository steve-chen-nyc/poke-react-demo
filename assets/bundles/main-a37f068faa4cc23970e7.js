...
/***/ function(module, exports, __webpack_require__) {
	...
	var green = __webpack_require__(169).colorGreen;
	var center = __webpack_require__(169).center;
	var images = __webpack_require__(169).images;
	    ...
	    if (this.state.data) {
	      ...
	      var pokeNodes = this.state.data.map(function (poke) {
	        return [React.createElement(
	          ...
	          poke.name,
	          ' '
	        ), React.createElement('img', { style: images, src: poke.picture_url }), React.createElement(
	          'p',
	          null,
	          ' ',
	          poke.description
