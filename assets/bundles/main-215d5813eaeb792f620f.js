...
/***/ function(module, exports, __webpack_require__) {
	...
	var green = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./style\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())).colorGreen;
	var center = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./style\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())).center;
	    ...
	    if (this.state.data) {
	      ...
	      var pokeNodes = this.state.data.map(function (poke) {
	        return [React.createElement(
	          ...
	          poke.name,
	          ' '
	        ), React.createElement('img', { src: poke.picture_url }), React.createElement(
	          'p',
	          null,
	          ' ',
	          poke.description
	...
	ReactDOM.render(React.createElement(PokemonList, { url: '/api/' }), document.getElementById('app'));
